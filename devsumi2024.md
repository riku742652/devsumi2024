...
- エンジニアリングが簡単になってるが技術的なチャレンジは減っている
    - ラップした技術を使っているが技術根本の複雑度は変わっていないという見方もある
...
- モメンタムを作る
    - 波を作る
    - 熱を作るやって行きの鍋を作る、盛り上がっているのを演出する


- 技術ブランディングをしてきた中で反省点、気づいたこと
    - １人プレイになりがち
    - ボトルネックが自分になりがち
    - メンバーへの頼り方
    - FBが次のカンファレンスへ生かせない
    - エンジニアが欲しい情報を与えないといけない
    - テックバリューの策定
...
- 品質
    ...
    - ピープル品質
        ...
        - 採用
        - →品質文化
        - 「誰をバスに乗せるのか」が重要 | ケースメソッド
            - https://www.nucba.ac.jp/active-learning/entry-22932.html
...
- 経営と現場の目指すものの乖離
    ...
    - リーンスタートアップ(本)
      ...
      - これらはビジネスとは相関がなく、ビジネスの成長を促すものであるべき
  - WHYから始めよ(本)
      ...
      - How-to(どうやって)
      - Who(誰が)
- 品質文化が価値をもたらすことにどう繋がるのか
    - 品質文化は組織文化に影響を与える
- 文化と組織は組織の両輪
    - 戦略を実現するために組織は文化を育む
    - 文化は戦略を容易に実行不能にできる
- 品質文化を可視化する(LEADING QUALITY)
    - 責任ナラティブ
    - テストナラティブ
        - 何を使う？
    - 価値ナラティブ
